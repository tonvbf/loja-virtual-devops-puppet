...
define jenkins::plugin(
  Optional[Variant[Stdlib::Compat::String, String]]   $version         = undef,
  Variant[Stdlib::Compat::Bool, Boolean]              $manage_config   = false,
  Optional[Variant[Stdlib::Compat::String, String]]   $config_filename = undef,
  Optional[Variant[Stdlib::Compat::String, String]]   $config_content  = undef,
  Optional[Variant[Stdlib::Compat::String, String]]   $update_url      = undef,
  Variant[Stdlib::Compat::Bool, Boolean]              $enabled         = true,
  Optional[Variant[Stdlib::Compat::String, String]]   $source          = undef,
  Optional[Variant[Stdlib::Compat::String, String]]   $digest_string   = undef,
  Variant[Stdlib::Compat::String, String]             $digest_type     = 'sha1',
  Variant[Stdlib::Compat::Bool, Boolean]              $pin             = true,
  # no worky
  Optional[Variant[Stdlib::Compat::Integer, Integer]] $timeout         = undef,
  # deprecated
  Optional[Variant[Stdlib::Compat::String, String]]   $plugin_dir      = undef,
  Optional[Variant[Stdlib::Compat::String, String]]   $username        = undef,
  Optional[Variant[Stdlib::Compat::String, String]]   $group           = undef,
  Optional                                            $create_user     = undef,
) {
  validate_legacy(Optional[String], 'validate_string', $version)
  validate_legacy(Boolean, 'validate_bool', $manage_config)
  validate_legacy(Optional[String], 'validate_string', $config_filename)
  validate_legacy(Optional[String], 'validate_string', $config_content)
  validate_legacy(Optional[String], 'validate_string', $update_url)
  validate_legacy(Boolean, 'validate_bool', $enabled)
  validate_legacy(Optional[String], 'validate_string', $source)
  validate_legacy(Optional[String], 'validate_string', $digest_string)
  validate_legacy(String, 'validate_string', $digest_type)
  validate_legacy(Boolean, 'validate_bool', $pin)
